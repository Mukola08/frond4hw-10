...
const timers = setInterval(()=>{
    count += 1;
    if (count === 5) clearInterval(timers);
    console.log("hello");
}, 1000);
console.log(timers);
// завдання 2
...
const box2 = setInterval(()=>{
    ...
    if (pos >= 250) clearInterval(box2);
}, 100);
//Завдання 3
const target = document.querySelector(".img"), scoreEl = document.querySelector(".score"), timeEl = document.querySelector(".time");
let score = 0, time = 10, timer, playing = false;
function move() {
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire9ef5", {})

//# sourceMappingURL=frond4hw-10.0f77c784.js.map
